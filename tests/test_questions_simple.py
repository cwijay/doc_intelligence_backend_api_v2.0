            ...
            if docs_data and "documents" in docs_data:
                ...
                if parsed_doc:
                    ...
                    if gen_response.status_code == 201:
                        ...
                        print(f"✅ Generated {len(gen_data.get('ai_questions', []))} questions")
                    ...
                    if get_response.status_code == 200:
                        ...
                        print(f"   Has questions: {get_data.get('has_questions', False)}")
                    ...
                    if update_response.status_code == 200:
                        ...
                        print(f"   Update type: {update_data.get('update_type', 'unknown')}")
                        print(f"   New count: {len(update_data.get('ai_questions', []))}")
                    else:
                        print(f"❌ Failed: {update_response.text}")
                    
                    print("\n✅ All tests completed successfully!")
                else:
                    print("❌ No parsed documents found. Please parse a document first.")
            else:
