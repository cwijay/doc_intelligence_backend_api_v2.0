...
class TokenExpiredError(AuthenticationError):
    ...
    def __init__(self, message: str = "Access token has expired", expires_at: Optional[str] = None):
        details = {}
        if expires_at:
...
class OrganizationNotFoundError(OrganizationError):
    ...
    def __init__(self, message: str = "Organization not found", org_id: Optional[str] = None):
...
class OrganizationAlreadyExistsError(OrganizationError):
    ...
    def __init__(self, message: str = "Organization already exists", org_name: Optional[str] = None):
...
class OrganizationInactiveError(OrganizationError):
    ...
    def __init__(self, message: str = "Organization is inactive", org_id: Optional[str] = None):
        details = {"organization_id": org_id} if org_id else None
        super().__init__(message, details)
...
class OrganizationAccessDeniedError(OrganizationError):
    ...
    def __init__(self, message: str = "Access denied to organization", org_id: Optional[str] = None):
        details = {"organization_id": org_id} if org_id else None
        super().__init__(message, details)
...
async def firestore_exception_handler(request: Request, exc: GoogleAPIError) -> JSONResponse:
