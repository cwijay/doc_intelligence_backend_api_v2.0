...
async def create_folder(
    ...
    try:
        ...
        if current_user["org_id"] != org_id:
            logger.warning("User attempted to create folder in different organization", 
                          user_id=user_id,
        ...
        logger.warning("Folder creation failed - name exists", 
                      org_id=org_id,
                      name=folder.name, 
                      error=str(e))
        raise HTTPException(
        ...
        logger.warning("Folder creation failed - validation error", 
                      org_id=org_id,
                      name=folder.name, 
                      error=str(e))
        raise HTTPException(
...
async def get_folder(
    ...
    try:
        ...
        logger.error("Failed to retrieve folder", 
                    org_id=org_id,
                    folder_id=folder_id, 
                    error=str(e))
        raise HTTPException(
...
async def list_folders(
    ...
    name: Optional[str] = Query(default=None, description="Filter by folder name (partial match)"),
    parent_folder_id: Optional[str] = Query(default=None, description="Filter by parent folder ID"),
    created_by: Optional[str] = Query(default=None, description="Filter by creator user ID"),
    ...
    try:
        ...
        logger.debug("Folders listed successfully", 
                    org_id=org_id,
...
async def get_folder_tree(
    ...
    try:
        ...
        logger.debug("Folder tree retrieved successfully", 
                    org_id=org_id,
...
async def update_folder(
    ...
    try:
        ...
        logger.warning("Folder update failed - not found", org_id=org_id, folder_id=folder_id)
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
            detail=f"Folder with ID {folder_id} not found"
        )
...
async def move_folder(
    ...
    try:
        ...
        logger.warning("Folder move failed - not found", org_id=org_id, folder_id=folder_id)
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
            detail=f"Folder with ID {folder_id} not found"
        )
    except FolderValidationError as e:
        logger.warning("Folder move failed - validation error", 
                      org_id=org_id,
                      folder_id=folder_id,
                      error=str(e))
        raise HTTPException(
...
async def delete_folder(
    ...
    try:
        ...
        logger.warning("Folder deletion failed - not found", org_id=org_id, folder_id=folder_id)
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
            detail=f"Folder with ID {folder_id} not found"
        )
...
async def get_folder_path(
    ...
    try:
        ...
        logger.warning("Folder path retrieval failed - not found", org_id=org_id, folder_id=folder_id)
        raise HTTPException(
            status_code=status.HTTP_404_NOT_FOUND,
            detail=f"Folder with ID {folder_id} not found"
        )
    except Exception as e:
        logger.error("Failed to retrieve folder path", 
                    org_id=org_id,
                    folder_id=folder_id, 
                    error=str(e))
        raise HTTPException(
...
async def get_folder_stats(
    ...
    try:
        ...
        logger.error("Failed to retrieve folder statistics", org_id=org_id, error=str(e))
        raise HTTPException(
            status_code=status.HTTP_500_INTERNAL_SERVER_ERROR,
