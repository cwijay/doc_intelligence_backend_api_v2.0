...
class PasswordRequirementsResponse(BaseModel):
    ...
    requires_lowercase: bool = Field(..., description="Requires at least one lowercase letter")
    requires_uppercase: bool = Field(..., description="Requires at least one uppercase letter")
    requires_digit: bool = Field(..., description="Requires at least one digit")
    requires_special: bool = Field(..., description="Requires at least one special character")
    allowed_special_chars: str = Field(..., description="List of allowed special characters")
    forbidden_patterns: list[str] = Field(..., description="List of forbidden common patterns")
...
async def validate_password(request: PasswordValidationRequest) -> PasswordValidationResponse:
    """
    ...
    requirements_met = {
        ...
        "not_common": password.lower() not in ['password', '12345678', 'qwerty123', 'password123']
    }
