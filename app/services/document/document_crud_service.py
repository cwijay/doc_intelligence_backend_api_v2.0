...
class DocumentCrudService(DocumentBaseService):
    ...
    async def create_document(
        ...
        try:
            ...
            if target_path:
                ...
                storage_path = validation_service._validate_target_path(target_path, file.filename)
            ...
            storage_path = await storage_service._ensure_unique_storage_path(org_id, storage_path, file.filename)
    ...
    async def delete_document(self, org_id: str, document_id: str) -> Dict[str, Any]:
        ...
        try:
            ...
            self.logger.info("Document soft deleted", 
                           org_id=org_id,
                           document_id=document_id,
