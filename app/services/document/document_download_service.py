...
class DocumentDownloadService(DocumentBaseService):
        ...
        try:
            ...
            try:
                ...
                return DocumentDownloadResponse(
                    ...
                    file_size=document_response.file_size,
                    content_type=self._get_content_type_from_file_type(document_response.file_type)
                )
            ...
            self.logger.error("Error generating download URL", 
                            ...
                            user_id=user_id,
                            error=str(e))
            raise DocumentUploadError(f"Unexpected error during download URL generation: {e}")
        ...
        try:
            ...
            for document_id in unique_document_ids:
                try:
                    ...
                    self.logger.warning("Failed to generate download URL in bulk operation", 
                                      org_id=org_id,
                                      document_id=document_id,
                                      user_id=user_id,
                                      error=str(e))
            
            self.logger.info("Bulk download URLs generated", 
                           org_id=org_id,
            ...
            return {
                ...
                "success_rate": len(successful_downloads) / len(unique_document_ids) if unique_document_ids else 0,
                "expiration_minutes": expiration_minutes,
            ...
            self.logger.error("Error in bulk download operation", 
                            org_id=org_id,
    ...
    async def validate_download_access(
        ...
        try:
            ...
            self.logger.debug("Download access validated", 
                            org_id=org_id,
                            document_id=document_id,
            ...
            self.logger.error("Error validating download access", 
                            org_id=org_id,
                            document_id=document_id,
                            user_id=user_id,
                            error=str(e))
    ...
    async def get_download_statistics(
        ...
        try:
            ...
            self.logger.info("Download statistics requested", 
                           org_id=org_id,
            ...
            self.logger.error("Error getting download statistics", 
                            org_id=org_id,
                            error=str(e))
            return {
                "org_id": org_id,
